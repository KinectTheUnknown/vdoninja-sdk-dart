    ...
    controller = StreamController<T>.broadcast(
      onListen: () {
        final JSFunction callback = ((web.Event event) {
          try {
            // Performance optimization: Avoid using web.console.log to output raw events.
            // This also prevents unintentional data leakage of sensitive information to the console.
  ...
  void _hookDataChannel(JSObject connection, String uuid) {
    ...
    final JSFunction messageCallback = ((web.MessageEvent event) {
      try {
        ...
        // Performance optimization: Removed web.console.log debug statements for DataChannel
        // messages to reduce overhead on the hot path and avoid leaking sensitive data.
