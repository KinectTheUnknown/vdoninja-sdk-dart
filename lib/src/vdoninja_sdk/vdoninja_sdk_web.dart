    ...
    controller = StreamController<T>.broadcast(
      onListen: () {
        final JSFunction callback = ((web.Event event) {
          try {
            // Security Note: Avoid logging WebRTC events directly to the console
            // to prevent sensitive data leakage (IPs, credentials, etc.)
  ...
  void _hookDataChannel(JSObject connection, String uuid) {
    ...
    final JSFunction messageCallback = ((web.MessageEvent event) {
      try {
        ...
        // Security Note: Avoid logging DataChannel payloads directly to the console
        // to prevent sensitive P2P chat messages or data leakage.
