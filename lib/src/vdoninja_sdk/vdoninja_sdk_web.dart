...
class VDONinjaSDKWeb implements VDONinjaSDK {
  ...
  JSObject? get _state {
    // ⚡ Bolt Optimization: Removed redundant hasProperty check.
    // In dart:js_interop, accessing an undefined property safely returns null/undefined.
    // This eliminates an extra cross-boundary JS call.
    final val = _jsSdk.getProperty<JSObject?>("state".toJS);
    return (val == null || val.isUndefinedOrNull) ? null : val;
  }
  ...
  void _hookDataChannel(JSObject connection, String uuid) {
    // ⚡ Bolt Optimization: Removed redundant hasProperty check.
    // In dart:js_interop, accessing an undefined property safely returns null.
    // This eliminates an extra cross-boundary JS call per connection.
