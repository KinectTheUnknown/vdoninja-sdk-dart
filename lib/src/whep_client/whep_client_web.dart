...
class WHEPClientWeb implements WHEPClient {
  ...
  Stream<dynamic> get onTrack => _getStream("track", (event) {
    // Performance optimization: Use direct getter access with type check
    // to avoid string allocations and cross-boundary overhead in hot paths
...
extension type _WindowWHEPClientExt(web.Window _) implements web.Window {
  @JS("WHEPClient")
...
bool get isWHEPLibraryLoaded {
  ...
  final val = (web.window as _WindowWHEPClientExt).whepClient;
